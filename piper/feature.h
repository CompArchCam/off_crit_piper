 ...
 * 
 * Features are components that can be trained online to predict branch outcomes.
 * Each feature maintains its own state and provides indexing into prediction tables.
 */
class Feature {
public:
    /**
