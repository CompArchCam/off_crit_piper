...
private:
  struct LocalHist {
    ...
    uint64_t hash() const { return hash_64(bits); }
  };
...
// ============================================================================
// PHistFeature (Path History based on branch targets)
// ============================================================================
class PHistFeature : public Feature {
private:
  RollingHistory<8> history;
  size_t hist_len;
  size_t shift;
...
// ============================================================================
// FHistFeature (Forward Branch History)
// ============================================================================
class FHistFeature : public Feature {
private:
  RollingHistory<8> history;
  size_t hist_len;
...
// ============================================================================
// BHistFeature (Backward Branch History)
// ============================================================================
class BHistFeature : public Feature {
private:
  RollingHistory<8> history;
  size_t hist_len;
...
// ============================================================================
// SLHistFeature (Second Local History - per block history)
// ============================================================================
class SLHistFeature : public Feature {
private:
...
public:
  ...
  void update(InstClass inst_class, uint64_t pc, bool actual_outcome,
    ...
    histories[idx] = ((histories[idx] << 1) + (actual_outcome ? 1 : 0)) &
                     ((1ULL << hist_len) - 1);
...
// ============================================================================
// TLHistFeature (Third Local History - different hash/table)
// ============================================================================
class TLHistFeature : public Feature {
private:
  std::vector<uint64_t> histories;
  size_t num_entries;
  size_t hist_len;
...
// ============================================================================
// QLHistFeature (Fourth Local History - mixes GH)
// ============================================================================
class QLHistFeature : public Feature {
private:
  std::vector<uint64_t> histories;
  size_t num_entries;
  size_t hist_len;
...
public:
  ...
  void update(InstClass inst_class, uint64_t pc, bool actual_outcome,
    ...
    histories[idx] =
        ((histories[idx] << 3) + update_val) & ((1ULL << hist_len) - 1);
